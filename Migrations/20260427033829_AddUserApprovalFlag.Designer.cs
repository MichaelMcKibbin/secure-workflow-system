...
namespace secure_workflow_system.Migrations
{
    ...
    [Migration("20260427033829_AddUserApprovalFlag")]
    partial class AddUserApprovalFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("secure_workflow_system.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("secure_workflow_system.Data.Case", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("secure_workflow_system.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("secure_workflow_system.Data.Case", b =>
                {
                    b.HasOne("secure_workflow_system.Data.ApplicationUser", "AssignedToUser")
                        .WithMany()
                        .HasForeignKey("AssignedToUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("secure_workflow_system.Data.ApplicationUser", "CreatedByUser")
                        .WithMany()
